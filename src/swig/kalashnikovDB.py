...
AK_CONSTRAINTS_BEWTEEN = _kalashnikovDB.AK_CONSTRAINTS_BEWTEEN
AK_CONSTRAINTS_CHECK_CONSTRAINT = _kalashnikovDB.AK_CONSTRAINTS_CHECK_CONSTRAINT
AK_CONSTRAINTS_NOT_NULL = _kalashnikovDB.AK_CONSTRAINTS_NOT_NULL
AK_CONSTRAINTS_UNIQUE = _kalashnikovDB.AK_CONSTRAINTS_UNIQUE
AK_REFERENCE = _kalashnikovDB.AK_REFERENCE
...
class list_node(_object):
    ...
    if _newclass:type = _swig_property(_kalashnikovDB.list_node_type_get, _kalashnikovDB.list_node_type_set)
    __swig_setmethods__["size"] = _kalashnikovDB.list_node_size_set
    __swig_getmethods__["size"] = _kalashnikovDB.list_node_size_get
    if _newclass:size = _swig_property(_kalashnikovDB.list_node_size_get, _kalashnikovDB.list_node_size_set)
    ...
    if _newclass:table = _swig_property(_kalashnikovDB.list_node_table_get, _kalashnikovDB.list_node_table_set)
    ...
    if _newclass:attribute_name = _swig_property(_kalashnikovDB.list_node_attribute_name_get, _kalashnikovDB.list_node_attribute_name_set)
    ...
    if _newclass:constraint = _swig_property(_kalashnikovDB.list_node_constraint_get, _kalashnikovDB.list_node_constraint_set)
...
def Ak_InsertAtEnd_L4(*args):
  return _kalashnikovDB.Ak_InsertAtEnd_L4(*args)
Ak_InsertAtEnd_L4 = _kalashnikovDB.Ak_InsertAtEnd_L4
...
class AK_block(_object):
    ...
    if _newclass:AK_free_space = _swig_property(_kalashnikovDB.AK_block_AK_free_space_get, _kalashnikovDB.AK_block_AK_free_space_set)
...
class AK_blocktable(_object):
    ...
    if _newclass:allocationtable = _swig_property(_kalashnikovDB.AK_blocktable_allocationtable_get, _kalashnikovDB.AK_blocktable_allocationtable_set)
    ...
    if _newclass:bittable = _swig_property(_kalashnikovDB.AK_blocktable_bittable_get, _kalashnikovDB.AK_blocktable_bittable_set)
    ...
    if _newclass:last_allocated = _swig_property(_kalashnikovDB.AK_blocktable_last_allocated_get, _kalashnikovDB.AK_blocktable_last_allocated_set)
    ...
    if _newclass:last_initialized = _swig_property(_kalashnikovDB.AK_blocktable_last_initialized_get, _kalashnikovDB.AK_blocktable_last_initialized_set)
    ...
    if _newclass:prepared = _swig_property(_kalashnikovDB.AK_blocktable_prepared_get, _kalashnikovDB.AK_blocktable_prepared_set)
    ...
    if _newclass:ltime = _swig_property(_kalashnikovDB.AK_blocktable_ltime_get, _kalashnikovDB.AK_blocktable_ltime_set)
    def __init__(self): 
...
class AK_block_activity(_object):
    ...
    if _newclass:locked_for_reading = _swig_property(_kalashnikovDB.AK_block_activity_locked_for_reading_get, _kalashnikovDB.AK_block_activity_locked_for_reading_set)
    ...
    if _newclass:locked_for_writing = _swig_property(_kalashnikovDB.AK_block_activity_locked_for_writing_get, _kalashnikovDB.AK_block_activity_locked_for_writing_set)
    ...
    if _newclass:block_lock = _swig_property(_kalashnikovDB.AK_block_activity_block_lock_get, _kalashnikovDB.AK_block_activity_block_lock_set)
    ...
    if _newclass:writing_done = _swig_property(_kalashnikovDB.AK_block_activity_writing_done_get, _kalashnikovDB.AK_block_activity_writing_done_set)
    ...
    if _newclass:reading_done = _swig_property(_kalashnikovDB.AK_block_activity_reading_done_get, _kalashnikovDB.AK_block_activity_reading_done_set)
    ...
    if _newclass:thread_holding_lock = _swig_property(_kalashnikovDB.AK_block_activity_thread_holding_lock_get, _kalashnikovDB.AK_block_activity_thread_holding_lock_set)
    def __init__(self): 
...
def AK_increase_extent(*args):
  return _kalashnikovDB.AK_increase_extent(*args)
AK_increase_extent = _kalashnikovDB.AK_increase_extent

def AK_get_extent(*args):
  return _kalashnikovDB.AK_get_extent(*args)
AK_get_extent = _kalashnikovDB.AK_get_extent

def AK_get_allocation_set(*args):
  return _kalashnikovDB.AK_get_allocation_set(*args)
AK_get_allocation_set = _kalashnikovDB.AK_get_allocation_set

def AK_copy_header(*args):
  return _kalashnikovDB.AK_copy_header(*args)
AK_copy_header = _kalashnikovDB.AK_copy_header

def AK_allocate_blocks(*args):
  return _kalashnikovDB.AK_allocate_blocks(*args)
...
def AK_allocationtable_dump(*args):
  return _kalashnikovDB.AK_allocationtable_dump(*args)
AK_allocationtable_dump = _kalashnikovDB.AK_allocationtable_dump

def AK_blocktable_dump(*args):
  return _kalashnikovDB.AK_blocktable_dump(*args)
...
def fsize(*args):
  return _kalashnikovDB.fsize(*args)
...
def AK_cache_result(*args):
  return _kalashnikovDB.AK_cache_result(*args)
...
def AK_mem_block_modify(*args):
  return _kalashnikovDB.AK_mem_block_modify(*args)
...
def AK_get_index_segment_addresses(*args):
  return _kalashnikovDB.AK_get_index_segment_addresses(*args)
...
def AK_find_AK_free_space(*args):
  return _kalashnikovDB.AK_find_AK_free_space(*args)
...
class AK_command_recovery_struct(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, AK_command_recovery_struct, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, AK_command_recovery_struct, name)
    __repr__ = _swig_repr
    __swig_setmethods__["operation"] = _kalashnikovDB.AK_command_recovery_struct_operation_set
    __swig_getmethods__["operation"] = _kalashnikovDB.AK_command_recovery_struct_operation_get
    if _newclass:operation = _swig_property(_kalashnikovDB.AK_command_recovery_struct_operation_get, _kalashnikovDB.AK_command_recovery_struct_operation_set)
    __swig_setmethods__["table_name"] = _kalashnikovDB.AK_command_recovery_struct_table_name_set
    __swig_getmethods__["table_name"] = _kalashnikovDB.AK_command_recovery_struct_table_name_get
    if _newclass:table_name = _swig_property(_kalashnikovDB.AK_command_recovery_struct_table_name_get, _kalashnikovDB.AK_command_recovery_struct_table_name_set)
    __swig_setmethods__["arguments"] = _kalashnikovDB.AK_command_recovery_struct_arguments_set
    __swig_getmethods__["arguments"] = _kalashnikovDB.AK_command_recovery_struct_arguments_get
    if _newclass:arguments = _swig_property(_kalashnikovDB.AK_command_recovery_struct_arguments_get, _kalashnikovDB.AK_command_recovery_struct_arguments_set)
    __swig_setmethods__["finished"] = _kalashnikovDB.AK_command_recovery_struct_finished_set
    __swig_getmethods__["finished"] = _kalashnikovDB.AK_command_recovery_struct_finished_get
    if _newclass:finished = _swig_property(_kalashnikovDB.AK_command_recovery_struct_finished_get, _kalashnikovDB.AK_command_recovery_struct_finished_set)
    def __init__(self): 
        this = _kalashnikovDB.new_AK_command_recovery_struct()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _kalashnikovDB.delete_AK_command_recovery_struct
    __del__ = lambda self : None;
AK_command_recovery_struct_swigregister = _kalashnikovDB.AK_command_recovery_struct_swigregister
AK_command_recovery_struct_swigregister(AK_command_recovery_struct)
...
class AK_redo_log(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["command_recovery"] = _kalashnikovDB.AK_redo_log_command_recovery_set
    __swig_getmethods__["command_recovery"] = _kalashnikovDB.AK_redo_log_command_recovery_get
    if _newclass:command_recovery = _swig_property(_kalashnikovDB.AK_redo_log_command_recovery_get, _kalashnikovDB.AK_redo_log_command_recovery_set)
    ...
    if _newclass:number = _swig_property(_kalashnikovDB.AK_redo_log_number_get, _kalashnikovDB.AK_redo_log_number_set)
    def __init__(self): 
...
class AK_results(_object):
    ...
    if _newclass:source_table = _swig_property(_kalashnikovDB.AK_results_source_table_get, _kalashnikovDB.AK_results_source_table_set)
    ...
    if _newclass:result_block = _swig_property(_kalashnikovDB.AK_results_result_block_get, _kalashnikovDB.AK_results_result_block_set)
    ...
    if _newclass:header = _swig_property(_kalashnikovDB.AK_results_header_get, _kalashnikovDB.AK_results_header_set)
    def __init__(self): 
...
def get_row_attr_data(*args):
  return _kalashnikovDB.get_row_attr_data(*args)
get_row_attr_data = _kalashnikovDB.get_row_attr_data
...
class AK_create_table_struct(_object):
    ...
    if _newclass:name = _swig_property(_kalashnikovDB.AK_create_table_struct_name_get, _kalashnikovDB.AK_create_table_struct_name_set)
    ...
    if _newclass:type = _swig_property(_kalashnikovDB.AK_create_table_struct_type_get, _kalashnikovDB.AK_create_table_struct_type_set)
    def __init__(self): 
...
def AK_index_table_exist(*args):
  return _kalashnikovDB.AK_index_table_exist(*args)
AK_index_table_exist = _kalashnikovDB.AK_index_table_exist

def AK_print_index_table(*args):
  return _kalashnikovDB.AK_print_index_table(*args)
AK_print_index_table = _kalashnikovDB.AK_print_index_table

def AK_get_index_tuple(*args):
  return _kalashnikovDB.AK_get_index_tuple(*args)
AK_get_index_tuple = _kalashnikovDB.AK_get_index_tuple

def AK_get_index_num_records(*args):
  return _kalashnikovDB.AK_get_index_num_records(*args)
AK_get_index_num_records = _kalashnikovDB.AK_get_index_num_records

def AK_num_index_attr(*args):
  return _kalashnikovDB.AK_num_index_attr(*args)
...
def AK_create_Index_Table(*args):
  return _kalashnikovDB.AK_create_Index_Table(*args)
...
def AK_add_to_bitmap_index(*args):
  return _kalashnikovDB.AK_add_to_bitmap_index(*args)
...
def AK_delete_bitmap_index(*args):
  return _kalashnikovDB.AK_delete_bitmap_index(*args)
...
def AK_btree_create(*args):
  return _kalashnikovDB.AK_btree_create(*args)
AK_btree_create = _kalashnikovDB.AK_btree_create

def AK_btree_delete(*args):
  return _kalashnikovDB.AK_btree_delete(*args)
AK_btree_delete = _kalashnikovDB.AK_btree_delete

def AK_btree_search_delete(*args):
  return _kalashnikovDB.AK_btree_search_delete(*args)
AK_btree_search_delete = _kalashnikovDB.AK_btree_search_delete

def AK_btree_insert(*args):
  return _kalashnikovDB.AK_btree_insert(*args)
...
class btree_node(_object):
    ...
    if _newclass:values = _swig_property(_kalashnikovDB.btree_node_values_get, _kalashnikovDB.btree_node_values_set)
    ...
    if _newclass:pointers = _swig_property(_kalashnikovDB.btree_node_pointers_get, _kalashnikovDB.btree_node_pointers_set)
    def __init__(self): 
...
class root_info(_object):
    ...
    if _newclass:root = _swig_property(_kalashnikovDB.root_info_root_get, _kalashnikovDB.root_info_root_set)
    __swig_setmethods__["level"] = _kalashnikovDB.root_info_level_set
    __swig_getmethods__["level"] = _kalashnikovDB.root_info_level_get
    if _newclass:level = _swig_property(_kalashnikovDB.root_info_level_get, _kalashnikovDB.root_info_level_set)
    def __init__(self): 
...
def AK_get_index_header(*args):
  return _kalashnikovDB.AK_get_index_header(*args)
...
def Ak_update_row_from_block(*args):
  return _kalashnikovDB.Ak_update_row_from_block(*args)
Ak_update_row_from_block = _kalashnikovDB.Ak_update_row_from_block

def Ak_delete_row_from_block(*args):
  return _kalashnikovDB.Ak_delete_row_from_block(*args)
...
def Ak_delete_row_by_id(*args):
  return _kalashnikovDB.Ak_delete_row_by_id(*args)
...
def AK_initialize_new_index_segment(*args):
  return _kalashnikovDB.AK_initialize_new_index_segment(*args)
...
def AK_drop_help_function(*args):
  return _kalashnikovDB.AK_drop_help_function(*args)
...
def AK_get_operator(*args):
  return _kalashnikovDB.AK_get_operator(*args)
AK_get_operator = _kalashnikovDB.AK_get_operator

def removeSubstring(*args):
  return _kalashnikovDB.removeSubstring(*args)
removeSubstring = _kalashnikovDB.removeSubstring

def AK_determine_header_type(*args):
  return _kalashnikovDB.AK_determine_header_type(*args)
AK_determine_header_type = _kalashnikovDB.AK_determine_header_type

def AK_create_header_name(*args):
  return _kalashnikovDB.AK_create_header_name(*args)
AK_create_header_name = _kalashnikovDB.AK_create_header_name
...
def AK_perform_operatrion(*args):
  return _kalashnikovDB.AK_perform_operatrion(*args)
AK_perform_operatrion = _kalashnikovDB.AK_perform_operatrion
...
class AK_operand(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, AK_operand, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, AK_operand, name)
    __repr__ = _swig_repr
    __swig_setmethods__["value"] = _kalashnikovDB.AK_operand_value_set
    __swig_getmethods__["value"] = _kalashnikovDB.AK_operand_value_get
    if _newclass:value = _swig_property(_kalashnikovDB.AK_operand_value_get, _kalashnikovDB.AK_operand_value_set)
    __swig_setmethods__["type"] = _kalashnikovDB.AK_operand_type_set
    __swig_getmethods__["type"] = _kalashnikovDB.AK_operand_type_get
    if _newclass:type = _swig_property(_kalashnikovDB.AK_operand_type_get, _kalashnikovDB.AK_operand_type_set)
    def __init__(self): 
        this = _kalashnikovDB.new_AK_operand()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _kalashnikovDB.delete_AK_operand
    __del__ = lambda self : None;
AK_operand_swigregister = _kalashnikovDB.AK_operand_swigregister
AK_operand_swigregister(AK_operand)
...
def AK_replace_wild_card(*args):
  return _kalashnikovDB.AK_replace_wild_card(*args)
AK_replace_wild_card = _kalashnikovDB.AK_replace_wild_card

def Ak_check_regex_expression(*args):
  return _kalashnikovDB.Ak_check_regex_expression(*args)
Ak_check_regex_expression = _kalashnikovDB.Ak_check_regex_expression

def Ak_check_regex_operator_expression(*args):
  return _kalashnikovDB.Ak_check_regex_operator_expression(*args)
Ak_check_regex_operator_expression = _kalashnikovDB.Ak_check_regex_operator_expression
...
def AK_get_table_id(*args):
  return _kalashnikovDB.AK_get_table_id(*args)
...
def Ak_set_constraint_unique(*args):
  return _kalashnikovDB.Ak_set_constraint_unique(*args)
Ak_set_constraint_unique = _kalashnikovDB.Ak_set_constraint_unique

def AK_read_constraint_unique(*args):
  return _kalashnikovDB.AK_read_constraint_unique(*args)
AK_read_constraint_unique = _kalashnikovDB.AK_read_constraint_unique

def AK_delete_constraint_unique(*args):
  return _kalashnikovDB.AK_delete_constraint_unique(*args)
AK_delete_constraint_unique = _kalashnikovDB.AK_delete_constraint_unique

def AK_unique_test():
  return _kalashnikovDB.AK_unique_test()
AK_unique_test = _kalashnikovDB.AK_unique_test

def condition_passed(*args):
  return _kalashnikovDB.condition_passed(*args)
condition_passed = _kalashnikovDB.condition_passed

def AK_set_check_constraint(*args):
  return _kalashnikovDB.AK_set_check_constraint(*args)
AK_set_check_constraint = _kalashnikovDB.AK_set_check_constraint

def AK_check_constraint(*args):
  return _kalashnikovDB.AK_check_constraint(*args)
AK_check_constraint = _kalashnikovDB.AK_check_constraint

def AK_check_constraint_test():
  return _kalashnikovDB.AK_check_constraint_test()
AK_check_constraint_test = _kalashnikovDB.AK_check_constraint_test
...
def AK_delete_constraint_not_null(*args):
  return _kalashnikovDB.AK_delete_constraint_not_null(*args)
AK_delete_constraint_not_null = _kalashnikovDB.AK_delete_constraint_not_null

def AK_null_test():
  return _kalashnikovDB.AK_null_test()
AK_null_test = _kalashnikovDB.AK_null_test

def AK_find_table_address(*args):
  return _kalashnikovDB.AK_find_table_address(*args)
AK_find_table_address = _kalashnikovDB.AK_find_table_address
...
def AK_print_constraints(*args):
  return _kalashnikovDB.AK_print_constraints(*args)
AK_print_constraints = _kalashnikovDB.AK_print_constraints
...
def AK_delete_constraint_between(*args):
  return _kalashnikovDB.AK_delete_constraint_between(*args)
AK_delete_constraint_between = _kalashnikovDB.AK_delete_constraint_between
...
class observable_transaction_struct(_object):
    ...
    if _newclass:AK_transaction_register_observer = _swig_property(_kalashnikovDB.observable_transaction_struct_AK_transaction_register_observer_get, _kalashnikovDB.observable_transaction_struct_AK_transaction_register_observer_set)
    ...
    if _newclass:AK_transaction_unregister_observer = _swig_property(_kalashnikovDB.observable_transaction_struct_AK_transaction_unregister_observer_get, _kalashnikovDB.observable_transaction_struct_AK_transaction_unregister_observer_set)
    ...
    if _newclass:AK_lock_released = _swig_property(_kalashnikovDB.observable_transaction_struct_AK_lock_released_get, _kalashnikovDB.observable_transaction_struct_AK_lock_released_set)
    ...
    if _newclass:AK_transaction_finished = _swig_property(_kalashnikovDB.observable_transaction_struct_AK_transaction_finished_get, _kalashnikovDB.observable_transaction_struct_AK_transaction_finished_set)
    ...
    if _newclass:AK_all_transactions_finished = _swig_property(_kalashnikovDB.observable_transaction_struct_AK_all_transactions_finished_get, _kalashnikovDB.observable_transaction_struct_AK_all_transactions_finished_set)
    ...
    if _newclass:observable = _swig_property(_kalashnikovDB.observable_transaction_struct_observable_get, _kalashnikovDB.observable_transaction_struct_observable_set)
    def __init__(self): 
...
def AK_user_add(*args):
  return _kalashnikovDB.AK_user_add(*args)
AK_user_add = _kalashnikovDB.AK_user_add

def AK_user_get_id(*args):
  return _kalashnikovDB.AK_user_get_id(*args)
AK_user_get_id = _kalashnikovDB.AK_user_get_id

def AK_user_remove_by_name(*args):
  return _kalashnikovDB.AK_user_remove_by_name(*args)
AK_user_remove_by_name = _kalashnikovDB.AK_user_remove_by_name

def AK_user_rename(*args):
  return _kalashnikovDB.AK_user_rename(*args)
AK_user_rename = _kalashnikovDB.AK_user_rename

def AK_group_add(*args):
  return _kalashnikovDB.AK_group_add(*args)
AK_group_add = _kalashnikovDB.AK_group_add

def AK_group_get_id(*args):
  return _kalashnikovDB.AK_group_get_id(*args)
AK_group_get_id = _kalashnikovDB.AK_group_get_id

def AK_group_remove_by_name(*args):
  return _kalashnikovDB.AK_group_remove_by_name(*args)
AK_group_remove_by_name = _kalashnikovDB.AK_group_remove_by_name

def AK_group_rename(*args):
  return _kalashnikovDB.AK_group_rename(*args)
AK_group_rename = _kalashnikovDB.AK_group_rename

def AK_grant_privilege_user(*args):
  return _kalashnikovDB.AK_grant_privilege_user(*args)
AK_grant_privilege_user = _kalashnikovDB.AK_grant_privilege_user

def AK_revoke_privilege_user(*args):
  return _kalashnikovDB.AK_revoke_privilege_user(*args)
AK_revoke_privilege_user = _kalashnikovDB.AK_revoke_privilege_user

def AK_revoke_all_privileges_user(*args):
  return _kalashnikovDB.AK_revoke_all_privileges_user(*args)
AK_revoke_all_privileges_user = _kalashnikovDB.AK_revoke_all_privileges_user

def AK_grant_privilege_group(*args):
  return _kalashnikovDB.AK_grant_privilege_group(*args)
AK_grant_privilege_group = _kalashnikovDB.AK_grant_privilege_group

def AK_revoke_privilege_group(*args):
  return _kalashnikovDB.AK_revoke_privilege_group(*args)
AK_revoke_privilege_group = _kalashnikovDB.AK_revoke_privilege_group

def AK_revoke_all_privileges_group(*args):
  return _kalashnikovDB.AK_revoke_all_privileges_group(*args)
AK_revoke_all_privileges_group = _kalashnikovDB.AK_revoke_all_privileges_group

def AK_add_user_to_group(*args):
  return _kalashnikovDB.AK_add_user_to_group(*args)
AK_add_user_to_group = _kalashnikovDB.AK_add_user_to_group

def AK_remove_user_from_all_groups(*args):
  return _kalashnikovDB.AK_remove_user_from_all_groups(*args)
AK_remove_user_from_all_groups = _kalashnikovDB.AK_remove_user_from_all_groups

def AK_remove_all_users_from_group(*args):
  return _kalashnikovDB.AK_remove_all_users_from_group(*args)
AK_remove_all_users_from_group = _kalashnikovDB.AK_remove_all_users_from_group

def AK_check_privilege(*args):
  return _kalashnikovDB.AK_check_privilege(*args)
AK_check_privilege = _kalashnikovDB.AK_check_privilege

def AK_check_user_privilege(*args):
  return _kalashnikovDB.AK_check_user_privilege(*args)
AK_check_user_privilege = _kalashnikovDB.AK_check_user_privilege

def AK_check_group_privilege(*args):
  return _kalashnikovDB.AK_check_group_privilege(*args)
...
def AK_trigger_rename(*args):
  return _kalashnikovDB.AK_trigger_rename(*args)
...
def AK_archive_log(*args):
  return _kalashnikovDB.AK_archive_log(*args)
AK_archive_log = _kalashnikovDB.AK_archive_log

def AK_empty_archive_log():
  return _kalashnikovDB.AK_empty_archive_log()
AK_empty_archive_log = _kalashnikovDB.AK_empty_archive_log

def AK_get_timestamp():
  return _kalashnikovDB.AK_get_timestamp()
AK_get_timestamp = _kalashnikovDB.AK_get_timestamp
...
class AK_command_struct(_object):
    ...
    if _newclass:id_command = _swig_property(_kalashnikovDB.AK_command_struct_id_command_get, _kalashnikovDB.AK_command_struct_id_command_set)
    ...
    if _newclass:tblName = _swig_property(_kalashnikovDB.AK_command_struct_tblName_get, _kalashnikovDB.AK_command_struct_tblName_set)
    ...
    if _newclass:parameters = _swig_property(_kalashnikovDB.AK_command_struct_parameters_get, _kalashnikovDB.AK_command_struct_parameters_set)
    def __init__(self): 
...
def iniparser_AK_freedict(*args):
  return _kalashnikovDB.iniparser_AK_freedict(*args)
...
def AK_check_function_arguments_type(*args):
  return _kalashnikovDB.AK_check_function_arguments_type(*args)
...
def AK_sequence_get_id(*args):
  return _kalashnikovDB.AK_sequence_get_id(*args)
...
def AK_redolog_commit():
  return _kalashnikovDB.AK_redolog_commit()
AK_redolog_commit = _kalashnikovDB.AK_redolog_commit

def AK_check_attributes(*args):
  return _kalashnikovDB.AK_check_attributes(*args)
AK_check_attributes = _kalashnikovDB.AK_check_attributes

def AK_recover_archive_log(*args):
  return _kalashnikovDB.AK_recover_archive_log(*args)
AK_recover_archive_log = _kalashnikovDB.AK_recover_archive_log

def AK_recovery_insert_row(*args):
  return _kalashnikovDB.AK_recovery_insert_row(*args)
AK_recovery_insert_row = _kalashnikovDB.AK_recovery_insert_row

def AK_recovery_tokenize(*args):
  return _kalashnikovDB.AK_recovery_tokenize(*args)
AK_recovery_tokenize = _kalashnikovDB.AK_recovery_tokenize

def AK_recovery_test():
  return _kalashnikovDB.AK_recovery_test()
AK_recovery_test = _kalashnikovDB.AK_recovery_test

def AK_recover_operation(*args):
  return _kalashnikovDB.AK_recover_operation(*args)
AK_recover_operation = _kalashnikovDB.AK_recover_operation

def Ak_check_constraint_name(*args):
  return _kalashnikovDB.Ak_check_constraint_name(*args)
Ak_check_constraint_name = _kalashnikovDB.Ak_check_constraint_name

def AK_constraint_names_test():
  return _kalashnikovDB.AK_constraint_names_test()
AK_constraint_names_test = _kalashnikovDB.AK_constraint_names_test
