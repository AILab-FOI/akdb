...
class AK_redo_log(_object):
    ...
    if _newclass:table_name = _swig_property(_kalashnikovDB.AK_redo_log_table_name_get, _kalashnikovDB.AK_redo_log_table_name_set)
    ...
    if _newclass:command = _swig_property(_kalashnikovDB.AK_redo_log_command_get, _kalashnikovDB.AK_redo_log_command_set)
    ...
    if _newclass:attributes = _swig_property(_kalashnikovDB.AK_redo_log_attributes_get, _kalashnikovDB.AK_redo_log_attributes_set)
...
def AK_get_table_row(*args):
  return _kalashnikovDB.AK_get_table_row(*args)
...
def AK_drop_test_helper(*args):
  return _kalashnikovDB.AK_drop_test_helper(*args)
...
def AK_recover_line(*args):
  return _kalashnikovDB.AK_recover_line(*args)
AK_recover_line = _kalashnikovDB.AK_recover_line

def AK_get_recovery_line_table(*args):
  return _kalashnikovDB.AK_get_recovery_line_table(*args)
AK_get_recovery_line_table = _kalashnikovDB.AK_get_recovery_line_table

def AK_recovery_get_id(*args):
  return _kalashnikovDB.AK_recovery_get_id(*args)
...
def AK_check_redolog_attributes(*args):
  return _kalashnikovDB.AK_check_redolog_attributes(*args)
