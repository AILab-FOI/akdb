...
_kalashnikovDB.AK_CONSTRAINTS_BEWTEEN_swigconstant(_kalashnikovDB)
AK_CONSTRAINTS_BEWTEEN = _kalashnikovDB.AK_CONSTRAINTS_BEWTEEN

_kalashnikovDB.AK_CONSTRAINTS_CHECK_CONSTRAINT_swigconstant(_kalashnikovDB)
AK_CONSTRAINTS_CHECK_CONSTRAINT = _kalashnikovDB.AK_CONSTRAINTS_CHECK_CONSTRAINT

_kalashnikovDB.AK_CONSTRAINTS_NOT_NULL_swigconstant(_kalashnikovDB)
AK_CONSTRAINTS_NOT_NULL = _kalashnikovDB.AK_CONSTRAINTS_NOT_NULL

_kalashnikovDB.AK_CONSTRAINTS_UNIQUE_swigconstant(_kalashnikovDB)
AK_CONSTRAINTS_UNIQUE = _kalashnikovDB.AK_CONSTRAINTS_UNIQUE

_kalashnikovDB.AK_REFERENCE_swigconstant(_kalashnikovDB)
...
def AK_init_system_tables_catalog(relation, attribute, index, view, sequence, function, function_arguments, trigger, trigger_conditions, db, db_obj, user, group, user_group, user_right, group_right, constraint, constraintNull, constraintCheck, constraintUnique, reference):
    return _kalashnikovDB.AK_init_system_tables_catalog(relation, attribute, index, view, sequence, function, function_arguments, trigger, trigger_conditions, db, db_obj, user, group, user_group, user_right, group_right, constraint, constraintNull, constraintCheck, constraintUnique, reference)
...
def AK_register_system_tables(relation, attribute, index, view, sequence, function, function_arguments, trigger, trigger_conditions, db, db_obj, user, group, user_group, user_right, group_right, constraint, constraintNull, constraintCheck, constraintUnique, reference):
    return _kalashnikovDB.AK_register_system_tables(relation, attribute, index, view, sequence, function, function_arguments, trigger, trigger_conditions, db, db_obj, user, group, user_group, user_right, group_right, constraint, constraintNull, constraintCheck, constraintUnique, reference)
...
class AK_command_recovery_struct(_object):
    ...
    if _newclass:
        operation = _swig_property(_kalashnikovDB.AK_command_recovery_struct_operation_get, _kalashnikovDB.AK_command_recovery_struct_operation_set)
    ...
    if _newclass:
        table_name = _swig_property(_kalashnikovDB.AK_command_recovery_struct_table_name_get, _kalashnikovDB.AK_command_recovery_struct_table_name_set)
    ...
    if _newclass:
        arguments = _swig_property(_kalashnikovDB.AK_command_recovery_struct_arguments_get, _kalashnikovDB.AK_command_recovery_struct_arguments_set)
    ...
    if _newclass:
        finished = _swig_property(_kalashnikovDB.AK_command_recovery_struct_finished_get, _kalashnikovDB.AK_command_recovery_struct_finished_set)
...
class AK_redo_log(_object):
    ...
    if _newclass:
        command_recovery = _swig_property(_kalashnikovDB.AK_redo_log_command_recovery_get, _kalashnikovDB.AK_redo_log_command_recovery_set)
...
def get_row_attr_data(column, node):
    return _kalashnikovDB.get_row_attr_data(column, node)
...
def AK_get_operator(exp):
    return _kalashnikovDB.AK_get_operator(exp)
AK_get_operator = _kalashnikovDB.AK_get_operator

def removeSubstring(s, toremove):
    return _kalashnikovDB.removeSubstring(s, toremove)
removeSubstring = _kalashnikovDB.removeSubstring

def AK_determine_header_type(a, b):
    return _kalashnikovDB.AK_determine_header_type(a, b)
AK_determine_header_type = _kalashnikovDB.AK_determine_header_type

def AK_create_header_name(first, second, operator):
    return _kalashnikovDB.AK_create_header_name(first, second, operator)
AK_create_header_name = _kalashnikovDB.AK_create_header_name

def AK_copy_block_projection(old_block, att, dstTable, expr):
    return _kalashnikovDB.AK_copy_block_projection(old_block, att, dstTable, expr)
AK_copy_block_projection = _kalashnikovDB.AK_copy_block_projection

def AK_perform_operatrion(op, ab, bb, type):
    return _kalashnikovDB.AK_perform_operatrion(op, ab, bb, type)
AK_perform_operatrion = _kalashnikovDB.AK_perform_operatrion

def AK_projection(srcTable, dstTable, att, expr):
    return _kalashnikovDB.AK_projection(srcTable, dstTable, att, expr)
...
class AK_operand(_object):
    ...
    if _newclass:
        value = _swig_property(_kalashnikovDB.AK_operand_value_get, _kalashnikovDB.AK_operand_value_set)
    __swig_setmethods__["type"] = _kalashnikovDB.AK_operand_type_set
    __swig_getmethods__["type"] = _kalashnikovDB.AK_operand_type_get
    if _newclass:
        type = _swig_property(_kalashnikovDB.AK_operand_type_get, _kalashnikovDB.AK_operand_type_set)
...
def AK_replace_wild_card(s, ch, repl):
    return _kalashnikovDB.AK_replace_wild_card(s, ch, repl)
AK_replace_wild_card = _kalashnikovDB.AK_replace_wild_card

def Ak_check_regex_expression(value, expression, sensitive, checkWildCard):
    return _kalashnikovDB.Ak_check_regex_expression(value, expression, sensitive, checkWildCard)
Ak_check_regex_expression = _kalashnikovDB.Ak_check_regex_expression

def Ak_check_regex_operator_expression(value, expression):
    return _kalashnikovDB.Ak_check_regex_operator_expression(value, expression)
...
def Ak_set_constraint_unique(tableName, attName, constraintName):
    return _kalashnikovDB.Ak_set_constraint_unique(tableName, attName, constraintName)
Ak_set_constraint_unique = _kalashnikovDB.Ak_set_constraint_unique

def AK_read_constraint_unique(tableName, attName, newValue):
    return _kalashnikovDB.AK_read_constraint_unique(tableName, attName, newValue)
AK_read_constraint_unique = _kalashnikovDB.AK_read_constraint_unique

def AK_delete_constraint_unique(tableName, attName, constraintName):
    return _kalashnikovDB.AK_delete_constraint_unique(tableName, attName, constraintName)
...
def condition_passed(condition, type, value, row_data):
    return _kalashnikovDB.condition_passed(condition, type, value, row_data)
condition_passed = _kalashnikovDB.condition_passed

def AK_set_check_constraint(table_name, constraint_name, attribute_name, condition, type, value):
    return _kalashnikovDB.AK_set_check_constraint(table_name, constraint_name, attribute_name, condition, type, value)
AK_set_check_constraint = _kalashnikovDB.AK_set_check_constraint

def AK_check_constraint(table, attribute, value):
    return _kalashnikovDB.AK_check_constraint(table, attribute, value)
...
def AK_delete_constraint_not_null(tableName, attName, constraintName):
    return _kalashnikovDB.AK_delete_constraint_not_null(tableName, attName, constraintName)
...
def AK_find_table_address(_systemTableName):
    return _kalashnikovDB.AK_find_table_address(_systemTableName)
...
def AK_print_constraints(tableName):
    return _kalashnikovDB.AK_print_constraints(tableName)
...
def AK_archive_log(sig):
    return _kalashnikovDB.AK_archive_log(sig)
...
def AK_command(commands, commandNum):
    return _kalashnikovDB.AK_command(commands, commandNum)
...
def AK_recover_operation(sig):
    return _kalashnikovDB.AK_recover_operation(sig)
AK_recover_operation = _kalashnikovDB.AK_recover_operation

def Ak_check_constraint_name(constraintName):
    return _kalashnikovDB.Ak_check_constraint_name(constraintName)
