...
class AK_blocks_currently_accessed(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, AK_blocks_currently_accessed, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, AK_blocks_currently_accessed, name)
    __repr__ = _swig_repr
    __swig_setmethods__["block"] = _kalashnikovDB.AK_blocks_currently_accessed_block_set
    __swig_getmethods__["block"] = _kalashnikovDB.AK_blocks_currently_accessed_block_get
    if _newclass:block = _swig_property(_kalashnikovDB.AK_blocks_currently_accessed_block_get, _kalashnikovDB.AK_blocks_currently_accessed_block_set)
    __swig_setmethods__["block_mutex"] = _kalashnikovDB.AK_blocks_currently_accessed_block_mutex_set
    __swig_getmethods__["block_mutex"] = _kalashnikovDB.AK_blocks_currently_accessed_block_mutex_get
    if _newclass:block_mutex = _swig_property(_kalashnikovDB.AK_blocks_currently_accessed_block_mutex_get, _kalashnikovDB.AK_blocks_currently_accessed_block_mutex_set)
    __swig_setmethods__["reading_writing"] = _kalashnikovDB.AK_blocks_currently_accessed_reading_writing_set
    __swig_getmethods__["reading_writing"] = _kalashnikovDB.AK_blocks_currently_accessed_reading_writing_get
    if _newclass:reading_writing = _swig_property(_kalashnikovDB.AK_blocks_currently_accessed_reading_writing_get, _kalashnikovDB.AK_blocks_currently_accessed_reading_writing_set)
    __swig_setmethods__["used"] = _kalashnikovDB.AK_blocks_currently_accessed_used_set
    __swig_getmethods__["used"] = _kalashnikovDB.AK_blocks_currently_accessed_used_get
    if _newclass:used = _swig_property(_kalashnikovDB.AK_blocks_currently_accessed_used_get, _kalashnikovDB.AK_blocks_currently_accessed_used_set)
    def __init__(self): 
        this = _kalashnikovDB.new_AK_blocks_currently_accessed()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _kalashnikovDB.delete_AK_blocks_currently_accessed
    __del__ = lambda self : None;
