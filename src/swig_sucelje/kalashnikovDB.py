...
def AK_config_get(*args):
  return _kalashnikovDB.AK_config_get(*args)
AK_config_get = _kalashnikovDB.AK_config_get
...
MAX_NUM_OF_BLOCKS = _kalashnikovDB.MAX_NUM_OF_BLOCKS
MAX_VARCHAR_LENGTH = _kalashnikovDB.MAX_VARCHAR_LENGTH
MAX_EXTENTS_IN_SEGMENT = _kalashnikovDB.MAX_EXTENTS_IN_SEGMENT
MAX_FREE_SPACE_SIZE = _kalashnikovDB.MAX_FREE_SPACE_SIZE
MAX_LAST_TUPLE_DICT_SIZE_TO_USE = _kalashnikovDB.MAX_LAST_TUPLE_DICT_SIZE_TO_USE
...
DB_FILE_SIZE = _kalashnikovDB.DB_FILE_SIZE
INITIAL_EXTENT_SIZE = _kalashnikovDB.INITIAL_EXTENT_SIZE
EXTENT_GROWTH_TABLE = _kalashnikovDB.EXTENT_GROWTH_TABLE
EXTENT_GROWTH_INDEX = _kalashnikovDB.EXTENT_GROWTH_INDEX
EXTENT_GROWTH_TRANSACTION = _kalashnikovDB.EXTENT_GROWTH_TRANSACTION
EXTENT_GROWTH_TEMP = _kalashnikovDB.EXTENT_GROWTH_TEMP
...
NUMBER_OF_THREADS = _kalashnikovDB.NUMBER_OF_THREADS
...
def AK_search_empty_link(*args):
  return _kalashnikovDB.AK_search_empty_link(*args)
...
class AK_redo_log(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["redo_log"] = _kalashnikovDB.AK_redo_log_redo_log_set
    __swig_getmethods__["redo_log"] = _kalashnikovDB.AK_redo_log_redo_log_get
    if _newclass:redo_log = _swig_property(_kalashnikovDB.AK_redo_log_redo_log_get, _kalashnikovDB.AK_redo_log_redo_log_set)
...
def rel_eq_comut_test():
  return _kalashnikovDB.rel_eq_comut_test()
rel_eq_comut_test = _kalashnikovDB.rel_eq_comut_test
...
class transaction_list_elem(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["id"] = _kalashnikovDB.transaction_list_elem_id_set
    __swig_getmethods__["id"] = _kalashnikovDB.transaction_list_elem_id_get
    if _newclass:id = _swig_property(_kalashnikovDB.transaction_list_elem_id_get, _kalashnikovDB.transaction_list_elem_id_set)
...
class transactionData(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["transactionId"] = _kalashnikovDB.transactionData_transactionId_set
    __swig_getmethods__["transactionId"] = _kalashnikovDB.transactionData_transactionId_get
    if _newclass:transactionId = _swig_property(_kalashnikovDB.transactionData_transactionId_get, _kalashnikovDB.transactionData_transactionId_set)
...
def AK_calculate_hash(*args):
  return _kalashnikovDB.AK_calculate_hash(*args)
AK_calculate_hash = _kalashnikovDB.AK_calculate_hash
...
def AK_search_hash_entry_list_by_key(*args):
  return _kalashnikovDB.AK_search_hash_entry_list_by_key(*args)
AK_search_hash_entry_list_by_key = _kalashnikovDB.AK_search_hash_entry_list_by_key
...
def AK_update_transaction_thread_count(*args):
  return _kalashnikovDB.AK_update_transaction_thread_count(*args)
AK_update_transaction_thread_count = _kalashnikovDB.AK_update_transaction_thread_count
